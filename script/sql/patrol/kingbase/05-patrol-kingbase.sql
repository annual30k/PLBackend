...
create index if not exists idx_patrol_device_tenant_online on patrol_device (tenant_id, online);
create index if not exists idx_patrol_alert_tenant_status on patrol_alert (tenant_id, status);
create index if not exists idx_patrol_alert_attachment_alert on patrol_alert_attachment (tenant_id, alert_id);
create index if not exists idx_patrol_alert_disposition_alert on patrol_alert_disposition (tenant_id, alert_id, occurred_at);
create unique index if not exists uk_patrol_media_file_side on patrol_media (tenant_id, file_id, storage_side);
create index if not exists idx_patrol_media_tenant_side on patrol_media (tenant_id, storage_side);
create index if not exists idx_patrol_upload_task_status on patrol_media_upload_task (tenant_id, status);
create index if not exists idx_patrol_upload_task_file on patrol_media_upload_task (tenant_id, file_id);
create index if not exists idx_patrol_sos_tenant_phase on patrol_sos_event (tenant_id, phase);
create index if not exists idx_patrol_sos_disposition_sos on patrol_sos_disposition (tenant_id, sos_id, occurred_at);
create index if not exists idx_patrol_track_badge_time on patrol_location_track (tenant_id, badge_no, reported_at);
create index if not exists idx_patrol_track_device_time on patrol_location_track (tenant_id, device_id, reported_at);
create index if not exists idx_patrol_command_device_time on patrol_device_command (tenant_id, device_id, sent_at);
create index if not exists idx_patrol_command_status on patrol_device_command (tenant_id, status);
create index if not exists idx_patrol_device_event_device_time on patrol_device_event (tenant_id, device_id, occurred_at);
create index if not exists idx_patrol_device_event_type on patrol_device_event (tenant_id, event_type);
create index if not exists idx_patrol_device_binding_device on patrol_device_binding (tenant_id, device_id, bind_status);
create index if not exists idx_patrol_device_binding_user on patrol_device_binding (tenant_id, user_name, bind_status);
create index if not exists idx_patrol_message_target on patrol_message (tenant_id, target_type, target_id);
create index if not exists idx_patrol_message_time on patrol_message (tenant_id, sent_at);
create unique index if not exists uk_patrol_message_receipt_user on patrol_message_receipt (tenant_id, message_id, recipient_id);
create index if not exists idx_patrol_message_receipt_message on patrol_message_receipt (tenant_id, message_id);
create index if not exists idx_patrol_message_receipt_target on patrol_message_receipt (tenant_id, recipient_id, device_id, delivery_status);
create index if not exists idx_patrol_audit_time on patrol_audit_log (tenant_id, occurred_at);
create index if not exists idx_patrol_audit_resource on patrol_audit_log (tenant_id, resource);
create index if not exists idx_patrol_control_person_status on patrol_control_person (tenant_id, status);
create index if not exists idx_patrol_control_person_name on patrol_control_person (tenant_id, name);
create index if not exists idx_patrol_control_vehicle_status on patrol_control_vehicle (tenant_id, status);
create index if not exists idx_patrol_control_vehicle_plate on patrol_control_vehicle (tenant_id, plate_no);
create unique index if not exists uk_patrol_device_config_device on patrol_device_config (tenant_id, device_id);
create index if not exists idx_patrol_app_version_status on patrol_app_version (tenant_id, status, version_code);
