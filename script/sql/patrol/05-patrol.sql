...
create table if not exists patrol_sos_event (
    ...
    user_id            bigint(20)    default null comment '发起用户ID',
    officer_name       varchar(120)  default null comment '发起警员姓名',
    badge_no           varchar(64)   default null comment '发起警员警号',
    dept_name          varchar(120)  default null comment '发起警员部门',
    device_id          varchar(64)   default null comment '发起设备ID',
    latitude           decimal(10,7) default null comment '纬度',
    longitude          decimal(10,7) default null comment '经度',
