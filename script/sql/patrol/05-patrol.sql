...
create table if not exists patrol_alert (
    ...
    latitude       decimal(10,7) default null comment '预警纬度',
    longitude      decimal(10,7) default null comment '预警经度',
    ...
    assigned_officer_name varchar(120) default null comment '指派警员',
    assigned_badge_no     varchar(64)  default null comment '指派警号',
    assigned_device_id    varchar(64)  default null comment '指派设备',
    create_dept    bigint(20)    default null comment '创建部门',
    create_by      bigint(20)    default null comment '创建者',
    create_time    datetime      default null comment '创建时间',
    update_by      bigint(20)    default null comment '更新者',
...
create table if not exists patrol_media (
    ...
    metadata_json     varchar(1000) default null comment '文件业务元数据JSON',
    create_dept       bigint(20)    default null comment '创建部门',
    create_by         bigint(20)    default null comment '创建者',
    create_time       datetime      default null comment '创建时间',
    update_by         bigint(20)    default null comment '更新者',
...
create table if not exists patrol_sos_event (
    ...
    assigned_officer_name varchar(120) default null comment '增援警员',
    assigned_badge_no     varchar(64)  default null comment '增援警号',
    assigned_device_id    varchar(64)  default null comment '增援设备',
    received_at          datetime      default null comment '接警时间',
    resolved_at          datetime      default null comment '完成时间',
    resolution_result    varchar(64)   default null comment '处置结果',
    resolution_note      varchar(1000) default null comment '处置说明',
    create_dept        bigint(20)    default null comment '创建部门',
    create_by          bigint(20)    default null comment '创建者',
    create_time        datetime      default null comment '创建时间',
    update_by          bigint(20)    default null comment '更新者',
